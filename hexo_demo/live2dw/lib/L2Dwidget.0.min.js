    ...
    ;(function (t) {
          ...
          for (
            ...
            if (_._$RP == N._$hs) {
              ...
              var u = t.getParamIndex(l),
                ...
                y =
                  f + (((g < d && d - g > c) || (g > d && g - d > c) ? g : g + (d - g) * s) - f) * i
              t.setParamFloat(l, y)
            }
          }
          n >= this._$yT &&
      ...
      ;(Z.prototype = new x()),
        ...
        (Z.transformPoints_sdk2 = function (e, i, r, o, n, s, a, _) {
          for (
            ...
            var P, S, v, L
            if (
              ((v = e[T]), (S = (L = e[T + 1]) * _), (P = v * a) < 0 || S < 0 || a <= P || _ <= S)
            ) {
              var M = a + 1
              if (!m) {
                ;(m = !0),
      ...
      ;(ot.tr = new gt()),
        ...
        (ot.createCanvas = function (t, e) {
          ...
          return (
            i.setAttribute('width', t), i.setAttribute('height', e), i || a._$li('err : ' + i), i
          )
        }),
      ...
      ;(ct.prototype._$tb = function () {
        ...
        (ct.prototype.startMotion = function (t, e) {
          ...
          return (
            this._$eb &&
              a._$Ji('MotionQueueManager[size:%2d]->startMotion() / new _$w0 (m%d)\n', r, n),
            n
          )
        }),
        ...
        for (n = 0; n < e.length; n++) {
          if (!((s = e[n].partsIndex) < 0))
            if (r == n) t.setPartsOpacity(s, o)
              ...
              ;(1 - (_ = o < 0.5 ? (-0.5 * o) / 0.5 + 1 : (0.5 * (1 - o)) / 0.5)) * (1 - o) >
                0.15 && (_ = 1 - 0.15 / (1 - o)),
                h > _ && (h = _),
    ...
    ;(_.prototype = new r.L2DBaseModel()),
      (_.prototype.load = function (t, e, i) {
        this.setUpdating(!0),
          ...
          (this.modelHomeDir = e.substring(0, e.lastIndexOf('/hexo_demo') + 1)),
